...
import sendLike from "../apiCalls/sendLike";
...
const Home = () => {
    ...
    const handleClick = (receive_user_id: number) => {
        return sendLike({
            send_user_id: parseInt(user_id),
                ...
                {users.map((user: any) => (
                    <Card key={user.user_id} className="mt-2">
                        ...
                        <CardFooter className="flex justify-between">
                            ...
                            <div className="mr-2">
                                <Button color="warning" size="lg" radius="full" onClick={() => handleClick(user.user_id)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
